    ...
    Column {
        ...
        Rectangle {
            ...
            TextField {
                ...
                font.pixelSize: 14
                color: "#333333"
                echoMode: TextInput.Password//密码回显
        ...
        Rectangle {
            width: parent.width
            height: 40
            color: logonBtnArea.pressed ? '#cec3c3' : (logonBtnArea.containsMouse ? "#ffffff" : "#FF8A5C")
            border.width: 2
            ...
            Text {
                text: qsTr("登录")
                color: logonBtnArea.pressed ? '#000000' : (logonBtnArea.containsMouse ? "#FF8A5C" : "#ffffff")
                    ...
                    if (agreementCheckbox.checked) {
                        ...
                        if (AccountBookSql.isConnected) {
                            ...
                            if (usernameInput.text == "" || passwordInput.text == "") {
                                ...
                                if (AccountBookSql.logonUser(usernameInput.text, passwordInput.text)) {
                                    //提示注册成功
                                    successPopup.open();
                                    logon.successShow();
                                } else {
